...
import xyz.k4czp3r.facenotify.models.BlacklistedDevice

class CompatibilityChecker {


    private val blacklistedDevices = listOf(BlacklistedDevice("OnePlus 7T Pro", "In OOS there is no option to show camera but not unlock device."))
