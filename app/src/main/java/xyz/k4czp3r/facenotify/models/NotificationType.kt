...
val HIDE_WHOLE_NOTIFICATION = NotificationType(0, FaceNotify.instance.applicationContext.getString(R.string.notification_mode_whole), InstructionTypes.whole_notification)
val HIDE_ONLY_CONTENT = NotificationType(1, FaceNotify.instance.applicationContext.getString(R.string.notification_mode_content), InstructionTypes.only_content)
